...
def test_check_evidence_sync_classifies_direct_fallback_doc_page_and_missing() -> None:
    rows = [
        EvidenceRow("ev_direct", "direct_ch_001", "약관", 1, 1),
        EvidenceRow("ev_fallback", "자사_SOL건강_v2_manual_ch_011755", "자사_SOL건강", 384, 384),
        EvidenceRow("ev_page", "약관_missing_ch_999999", "약관", 10, 10),
        EvidenceRow("ev_missing", "missing_ch_001", "없는문서", 1, 1),
    ]
    ...
    assert results[1].matched_id == "자사_SOL건강_ch_011755"
    assert results[2].matched_id == "약관_ch_000010"
