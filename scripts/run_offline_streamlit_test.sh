...
export SGLANG_CANDIDATE_MODELS="${SGLANG_CANDIDATE_MODELS:-gpt-oss-20b,gemma-4-26b-a4b-nvfp4}"
...
export VLLM_DEFAULT_MODEL="${VLLM_DEFAULT_MODEL:-gemma-4-26b-a4b-nvfp4}"
export VLLM_CANDIDATE_MODELS="${VLLM_CANDIDATE_MODELS:-gemma-4-26b-a4b-nvfp4}"
