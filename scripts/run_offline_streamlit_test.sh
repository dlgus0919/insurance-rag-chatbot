...
require_file "$AI_OPS_ROOT/llm/models/qwen3-next-80b-a3b-instruct-fp8/config.json" "SGLang Qwen3 Next 80B Instruct model"
require_file "$AI_OPS_ROOT/llm/models/gpt-oss-20b/config.json" "SGLang gpt-oss fallback model"
require_file "$AI_OPS_ROOT/llm/templates/gpt_oss_harmony.jinja" "GPT-OSS chat template"
require_file "$AI_OPS_ROOT/llm/models/gemma-4-31b-it-nvfp4/config.json" "Gemma4 31B vision candidate model"
